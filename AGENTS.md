...
- **`docs/compute-capacity.md`** — what a design delivers: picking the satellites
  that host a pipeline's stages, the serving conjunction, and what a fixed
  satellite and GPU budget buys. Start here for "how many shells, how deep".
